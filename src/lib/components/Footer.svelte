<footer class="mt-20 border-t border-[var(--border)]">
	<div class="mx-auto max-w-4xl px-6 py-8">
		<div class="flex flex-col items-center justify-between gap-4 sm:flex-row">
			<p class="text-sm text-[var(--text-muted)]">
				© {new Date().getFullYear()} Fajar Hidayad. Built with SvelteKit.
			</p>
			<div class="flex items-center gap-4">
				...
				<a
					href="https://linkedin.com/in/fajarhidayad"
					target="_blank"
					rel="noopener noreferrer"
					aria-label="LinkedIn"
					class="text-[var(--text-muted)] transition-colors hover:text-[var(--accent)]"
